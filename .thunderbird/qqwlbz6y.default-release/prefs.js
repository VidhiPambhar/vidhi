...
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1641383937);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 0);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1641383966);
...
user_pref("extensions.webextensions.uuids", "{\"default-theme@mozilla.org\":\"2af4ef94-ddeb-4f3d-908a-698a818110b9\"}");
user_pref("mail.ui-rdf.version", 23);
user_pref("mailnews.database.global.datastore.id", "d3a47c90-8a09-415c-8a0a-d273cd5a1d5");
...
user_pref("security.sandbox.plugin.tempDirSuffix", "60de3716-b85a-4b37-ad66-4286642ba014");
user_pref("toolkit.telemetry.cachedClientID", "cceea309-3e76-4491-8d13-cd846a978ffa");
